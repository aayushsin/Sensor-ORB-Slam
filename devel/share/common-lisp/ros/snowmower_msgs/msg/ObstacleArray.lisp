...
(cl:defclass <ObstacleArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (obstacles
    :reader obstacles
    :initarg :obstacles
    :type (cl:vector snowmower_msgs-msg:ObstacleMsg)
   :initform (cl:make-array 0 :element-type 'snowmower_msgs-msg:ObstacleMsg :initial-element (cl:make-instance 'snowmower_msgs-msg:ObstacleMsg))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ObstacleArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObstacleArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name snowmower_msgs-msg:<ObstacleArray> is deprecated: use snowmower_msgs-msg:ObstacleArray instead.")))
...
(cl:defmethod obstacles-val ((m <ObstacleArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader snowmower_msgs-msg:obstacles-val is deprecated.  Use snowmower_msgs-msg:obstacles instead.")
  (obstacles m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ObstacleArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'obstacles)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'snowmower_msgs-msg:ObstacleMsg))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ObstacleArray>)))
  ...
  "a7bdc34e10fcb03f3f7d1dd7dd5c5004")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ObstacleArray)))
  "Returns md5sum for a message object of type 'ObstacleArray"
  "a7bdc34e10fcb03f3f7d1dd7dd5c5004")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ObstacleArray>)))
  ...
  (cl:format cl:nil "Header header~%ObstacleMsg[] obstacles~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: snowmower_msgs/ObstacleMsg~%float64 angle~%float64 distance~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ObstacleArray)))
  "Returns full string definition for message of type 'ObstacleArray"
  (cl:format cl:nil "Header header~%ObstacleMsg[] obstacles~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: snowmower_msgs/ObstacleMsg~%float64 angle~%float64 distance~%~%"))
