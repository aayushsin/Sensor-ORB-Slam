...
(cl:defmethod cl:initialize-instance :after ((m <DecaWaveMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DecaWaveMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sensor_synchronizer-msg:<DecaWaveMsg> is deprecated: use sensor_synchronizer-msg:DecaWaveMsg instead.")))
...
(cl:defmethod dist-val ((m <DecaWaveMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_synchronizer-msg:dist-val is deprecated.  Use sensor_synchronizer-msg:dist instead.")
  (dist m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DecaWaveMsg>)))
  ...
  "sensor_synchronizer/DecaWaveMsg")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DecaWaveMsg)))
  "Returns string type for a message object of type 'DecaWaveMsg"
  "sensor_synchronizer/DecaWaveMsg")
