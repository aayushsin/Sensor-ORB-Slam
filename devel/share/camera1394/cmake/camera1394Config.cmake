...
if("TRUE" STREQUAL "TRUE")
  set(camera1394_SOURCE_PREFIX /home/yhlee/Sensor_Sync/src/camera1394)
  set(camera1394_DEVEL_PREFIX /home/yhlee/Sensor_Sync/devel)
  ...
  set(camera1394_INSTALL_PREFIX /home/yhlee/Sensor_Sync/install)
...
if(NOT "/home/yhlee/Sensor_Sync/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'camera1394' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yhlee/Sensor_Sync/src/camera1394/${idir}'.  Ask the maintainer 'Jack O'Quin <jack.oquin@gmail.com>' to fix it.")
    endif()
