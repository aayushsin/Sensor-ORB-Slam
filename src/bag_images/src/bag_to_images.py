...
class ImageCreator():
    ...
    def __init__(self):
        ...
        # Get parameters as arguments to 'rosrun my_package bag_to_images.py <save_dir> <filename>', where save_dir and filename exist relative to this executable file.e.g rosrun bag_images bag_to_images.py /home/aayushsingla/catkin_ws/src/bag_images subset.bag
